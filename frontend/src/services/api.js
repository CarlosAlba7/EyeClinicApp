...
export const reportAPI = {
  ...
  patientsByCondition: (condition) => api.get('/reports/patients-by-condition', { params: { condition } }),
  appointmentsByDateRange: (startDate, endDate) => api.get('/reports/appointments-by-date-range', { params: { startDate, endDate } }),
  outstandingInvoices: () => api.get('/reports/outstanding-invoices'),
  doctorWorkload: (month, year) => api.get('/reports/doctor-workload', { params: { month, year } }),
};
